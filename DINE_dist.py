...
if __name__ == "__main__":
    ...
    args.output_dir_src = osp.join(args.output_src, args.net_src,
                                   str(args.seed), 'uda', args.dset,
    ...
    if not args.distill:
        ...
        args.out_file = open(osp.join(args.output_dir_src, 'log_test.txt'),
                             'w')
